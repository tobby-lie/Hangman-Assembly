TITLE Test2_ExtraCredit.asm
;===================================================================================
; Author:  Tobby Lie
; Date:  9 April 2018
; Description:  TEST 2 Simple game of Hangman WITH EXTRA CREDIT
;
; Last updated: 4/11/18 12:43PM
; ====================================================================================
...
; ====================================================================================
optionAgain1:									;// validation loop

call clrscr

mov edx, offset viewStats						;// do you want to view game stats?
call writeString	
...
call lowerCaseChar								;// convert character to lower case

cmp al, 'y'										;// compare character for y or n or otherwise
je show
cmp al, 'n'
je dontshow
mov edx, offset errormessage					;// invalid input 
call writestring
call crlf
call waitmsg
jmp optionAgain1
...
show:
push ebx
mov eax, 0										;// prepare registers to display game stats
mov ebx, 0
mov ah, winCounter
mov al, lossCounter
mov bl, gameCounter
...
mov edx, offset viewStats						;// ask if user would like to view stats before exiting
call writeString
...
mov edx, offset emptyOptionInput
call writestring
call crlf
call waitmsg
jmp optionAgain2
...
mov edx, offset invalidOptionInput
call writestring
call crlf
call waitmsg
jmp optionAgain2
...
show1:
mov eax, 0										 ;// display stats upon request
mov ebx, 0
mov ah, winCounter
mov al, lossCounter
mov bl, gameCounter
call GameStats
; ====================================================================================
dontshow1:										;// otherwise just exit and print out thank you message
